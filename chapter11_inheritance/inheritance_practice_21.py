...
class Car(Automobile):
    ...
    def __str__(self):  #overriding parent class toString
...
class SUV(Automobile):
    ...
    def __str__(self):  #overriding parent class toString
        return super().__str__() + f", Passenger Cap: {self.__pass_cap}"

class EVehicle(Automobile):

    def __init__(self, make, model, mileage, price, batteryCap):
        #Automobile.__init__(self, make, model, mileage, price)
        #self.set_make("Honda")  # can do - but too lazy
        super().__init__(make, model, mileage, price)
        self.__batteryCap = batteryCap

    def get_batteryCap(self): # getter/accessor
        return self.__batteryCap
    
    def set_batteryCap(self, batCap):
        self.__batteryCap = batCap

    def __str__(self):  #overriding parent class toString
        return super().__str__() + f", Battery Capacity: {self.__batteryCap}"
...
def main():
    ...
    # for e-vehicle
    eveh = EVehicle('Honda', "Prolude", 1000, 45000, "90kWh")
    print(eveh)
    ...
    # print('Battery Capacity:', eveh.get_batteryCap())
